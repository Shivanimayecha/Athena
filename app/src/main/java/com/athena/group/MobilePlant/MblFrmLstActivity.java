...
import com.athena.group.adapter.MblReportAdapter;
...
public class MblFrmLstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbl_frm_lst);
        ButterKnife.bind(this);
        sessionManager = new SessionManager(MblFrmLstActivity.this);
        apiservice = ApiServiceCreator.createService("latest");
        toolbar_Title.setText(R.string.mblfrmlist);
    ...
    private void initViews() {
        ...
        Observable<PastHsModel> responseObservable = apiservice.get_mblPlantReport(
                ...
                .subscribe(new Observer<PastHsModel>() {
                    ...
                    public void onNext(PastHsModel model) {
                        ...
                        if (statusCode == 200) {
                            ...
                            adapter = new MblReportAdapter(MblFrmLstActivity.this, model.getData());
