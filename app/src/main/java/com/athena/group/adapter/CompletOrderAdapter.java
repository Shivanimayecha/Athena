...
public class CompletOrderAdapter extends RecyclerView.Adapter<CompletOrderAdapter.MyViewHolder> {
    ...
    public CompletOrderAdapter(Context mContext, List<OrderDetailsTruckModel.Data> arraylist) {
    ...
    @NonNull
    @Override
    public CompletOrderAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cmplt_order_details_truck, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CompletOrderAdapter.MyViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(view -> {
            ...
            intent.putExtra("screen", "Completeorder");
