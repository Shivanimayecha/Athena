...
public class AssignOrderDisplayAdapter extends RecyclerView.Adapter<AssignOrderDisplayAdapter.MyViewHolder> {

    Context mContext;
    List<OrderDetailsTruckModel.OrderDetail> orderDetails;

    public AssignOrderDisplayAdapter(Context mContext, List<OrderDetailsTruckModel.OrderDetail> orderDetails) {
    ...
    @NonNull
    @Override
    public AssignOrderDisplayAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.orderassi_product_details, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AssignOrderDisplayAdapter.MyViewHolder holder, int position) {
