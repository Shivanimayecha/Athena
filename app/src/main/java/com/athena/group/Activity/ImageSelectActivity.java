...
import com.athena.group.ConstantsCustomGallery;
import com.athena.group.R;
import com.athena.group.adapter.CustomImageSelectAdapter;
import com.athena.group.adapter.Image;
...
public class ImageSelectActivity extends HelperActivity {
    private ArrayList<com.athena.group.adapter.Image> images;
    ...
    protected void onStart() {
        ...
        handler = new Handler() {
            private Object ImageSelectActivity;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case ConstantsCustomGallery.FETCH_COMPLETED: {
                         ...
                         */
                        if (adapter == null) {
                            adapter = new CustomImageSelectAdapter((com.athena.group.Activity.ImageSelectActivity) ImageSelectActivity, getApplicationContext(), images);
...
//                    .show();
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (images != null) {
                com.athena.group.adapter.Image image;
                for (int i = 0, l = images.size(); i < l; i++) {
                    image = images.get(i);
            ...
            ArrayList<com.athena.group.adapter.Image> temp = new ArrayList<>(cursor.getCount());
            if (cursor.moveToLast()) {
                do {
                    ...
                    if (file.exists()) {
                        temp.add(new com.athena.group.adapter.Image(id, name, path, isSelected));
                    }
