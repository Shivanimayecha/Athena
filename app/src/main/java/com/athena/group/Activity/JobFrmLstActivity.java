...
public class JobFrmLstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_frm_lst);
        ButterKnife.bind(this);
        sessionManager = new SessionManager(JobFrmLstActivity.this);
        apiservice = ApiServiceCreator.createService("latest");
        toolbar_Title.setText(R.string.jobrevfrmlst);
    ...
    private void initViews() {
        ...
        Observable<PastHsModel> responseObservable = apiservice.get_jobReviewRport(
                ...
                .subscribe(new Observer<PastHsModel>() {
                    ...
                    public void onNext(PastHsModel model) {
                        ...
                        if (statusCode == 200) {
                            ...
                            adapter = new JobReportAdapter(JobFrmLstActivity.this, model.getData());
